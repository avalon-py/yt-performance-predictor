...
def title_features(title):
    words = title.split()
    capitalized_letter_count = sum(1 for c in title if c.isupper())
    return {
        ...
        "title_capitalized_letter_count": capitalized_letter_count,
        "title_capitalized_letter_ratio": capitalized_letter_count / len(title) if title else 0.0,
